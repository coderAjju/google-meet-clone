...
const page = () => {
  ...
  const handleLogin = async (provider) => {
    ...
    try {
      ...
      toast.error(`failed to login wiht ${provider}, please try again`);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="flex min-h-screen bg-gradient-to-r from-blue-100 to-purple-200 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="flex flex-col justify-center w-full p-8 lg:w-1/2">
        <div className="max-w-md mx-auto">
          <h1 className="mb-4 text-4xl font-bold">Welcome google meet</h1>
          <p className="mb-8 text-gray-600 dark:text-gray-100">
            connect with your team anytime, anywhere. Join or start meeting with
            crystal-clear HD video and audio.
          </p>
          <div className="space-y-4 ">
            <Button
              className="w-full dark:hover:bg-white bg-white dark:text-white text-black dark:hover:text-black "
              variant="outline"
