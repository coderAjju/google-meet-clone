    ...
    <div className='flex flex-col items-center'>
      <div className='relative'>
        <Image
          ...
          width={300}
          height={300}
          className='rounded-full h-40 w-40 md:w-64 md:h-64'
          
        />
        <Button variant = "ghost" size="icon" className="absolute top-1/2 -left-10 transform -translate-y-1/2 -translate-x-full" 
           onClick={prevSlide}
        >
          <ChevronLeft className='w-6 h-6'/>
        </Button>
        <Button variant = "ghost" size="icon" className="absolute top-1/2 -right-10 transform -translate-y-1/2 translate-x-full" 
           onClick={nextSlide}
        >
